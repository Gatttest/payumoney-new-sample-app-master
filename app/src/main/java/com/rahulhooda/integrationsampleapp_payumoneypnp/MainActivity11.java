...
public class MainActivity11 extends BaseActivity implements View.OnClickListener {
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(MainActivity11.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(MainActivity11.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
         }
    }
    /**
...
/*            *//**
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MainActivity11.this);
        ...
        protected String doInBackground(String... postParams) {
            ...
            try {
                ...
                final StringBuffer responseStringBuffer = new StringBuffer();
        ...
        protected void onPostExecute(String merchantHash) {
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(MainActivity11.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
                mPaymentParams.setMerchantHash(merchantHash);
                if (AppPreference.selectedTheme != -1) {
                    PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams, MainActivity11.this, AppPreference.selectedTheme, mAppPreference.isOverrideResultScreen());
                } else {
                    PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams, MainActivity11.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
                }
            }
        }
    }
