...
public class MainActivity55 extends BaseActivity implements View.OnClickListener {
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(MainActivity55.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(MainActivity55.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
         }
    }
    /**
...
/*            *//**
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MainActivity55.this);
        ...
        protected void onPostExecute(String merchantHash) {
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(MainActivity55.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
                mPaymentParams.setMerchantHash(merchantHash);
                if (AppPreference.selectedTheme != -1) {
                    PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams, MainActivity55.this, AppPreference.selectedTheme, mAppPreference.isOverrideResultScreen());
                } else {
                    PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams, MainActivity55.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
                }
            }
        }
    }
